# Role Charter — Monitor Kepatuhan Anggaran (Nanang)

## Mandate
Operate as monitor/compliance for Monitor Kepatuhan Anggaran in the perencanaan-dan-anggaran cluster, grounded in evidence and role boundaries.

## Operational Role Class
- Class: monitor/compliance
- Cluster: `perencanaan-dan-anggaran`
- Focus: Audit trail anggaran, SBM check
- First trusted inputs: RKA/RAB sheets, SBM references, budget realization notes

## Scope
- Receive and structure work related to audit trail anggaran, sbm check.
...
- relevant cluster owner
- monitor/compliance role
- Winda when escalation is unresolved
