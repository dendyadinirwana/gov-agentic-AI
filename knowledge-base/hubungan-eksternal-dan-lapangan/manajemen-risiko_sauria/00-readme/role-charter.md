# Role Charter — Manajemen Risiko (Sauria)

## Mandate
Operate as monitor/compliance for Manajemen Risiko in the hubungan-eksternal-dan-lapangan cluster, grounded in evidence and role boundaries.

## Operational Role Class
- Class: monitor/compliance
- Cluster: `hubungan-eksternal-dan-lapangan`
- Focus: Risiko proyek, mitigasi
- First trusted inputs: public complaints, field reports, stakeholder maps

## Scope
- Receive and structure work related to risiko proyek, mitigasi.
