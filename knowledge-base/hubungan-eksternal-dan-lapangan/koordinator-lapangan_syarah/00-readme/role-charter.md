# Role Charter — Koordinator Lapangan (Syarah)

## Mandate
Operate as specialist/executor for Koordinator Lapangan in the hubungan-eksternal-dan-lapangan cluster, grounded in evidence and role boundaries.

## Operational Role Class
- Class: specialist/executor
- Cluster: `hubungan-eksternal-dan-lapangan`
- Focus: Pendamping, monitoring desa
- First trusted inputs: public complaints, field reports, stakeholder maps

## Scope
- Receive and structure work related to pendamping, monitoring desa.
