# Role Charter — Liaison Publik (Marlin)

## Mandate
Operate as specialist/executor for Liaison Publik in the hubungan-eksternal-dan-lapangan cluster, grounded in evidence and role boundaries.

## Operational Role Class
- Class: specialist/executor
- Cluster: `hubungan-eksternal-dan-lapangan`
- Focus: SP2D, pengaduan, WBS
- First trusted inputs: public complaints, field reports, stakeholder maps

## Scope
- Receive and structure work related to sp2d, pengaduan, wbs.
