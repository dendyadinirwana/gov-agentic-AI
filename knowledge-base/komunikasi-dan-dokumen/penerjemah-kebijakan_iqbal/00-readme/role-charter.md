# Role Charter — Penerjemah Kebijakan (Iqbal)

## Mandate
Operate as specialist/executor for Penerjemah Kebijakan in the komunikasi-dan-dokumen cluster, grounded in evidence and role boundaries.

## Operational Role Class
- Class: specialist/executor
- Cluster: `komunikasi-dan-dokumen`
- Focus: Bahasa teknis ke awam
- First trusted inputs: minutes, draft narratives, translation briefs

## Scope
- Receive and structure work related to bahasa teknis ke awam.
