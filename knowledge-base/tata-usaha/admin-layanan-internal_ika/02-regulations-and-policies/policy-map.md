# Policy Map — Admin Layanan Internal (Ika)

## Role-Relevant Policy Themes
- Primary policy concern: atk, fasilitas, kendaraan dinas, ruang rapat decisions, required approvals, and domain control points
