...
required_root = [
    ...
    'docs/operations/RUNTIME_IMPLEMENTER_GUIDE.md',
    'examples/BOOTSTRAP_EXAMPLE.json',
    'examples/runtime-bootstrap/central-home-present.runtime-bootstrap.json',
    'examples/runtime-bootstrap/central-home-missing.runtime-bootstrap.json',
    'examples/runtime-bootstrap/shim-missing-yayak.runtime-bootstrap.json',
    'examples/runtime-bootstrap/production-approval-gated.runtime-bootstrap.json',
    'scripts/uninstall_gov_agentic_ai.py',
    'scripts/smoke_test_runtime_attach.py',
