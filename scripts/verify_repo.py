...
required_root = [
    ...
    'examples/agent-to-agent/budget-review.request.json',
    'examples/agent-to-agent/procurement-neutrality.request.json',
    'examples/agent-to-agent/archive-record.request.json',
    'examples/agent-to-agent/escalation-blocker.request.json',
    'examples/agent-to-agent/retrieval-budget-review.request.json',
    'examples/agent-to-agent/hitl-review.request.json',
    ...
    'scripts/smoke_test_agent_to_agent_matrix.py',
